    ...
    <div class="container bg-light py-4  ">
      <div class="col-12 p-2 ScrollingJobs my-2  shadow-lg" id="kashif">
        ...
        <div class="col-6 p-2 w-100 JobListItem bg-white rounded my-3">
          ...
          <div class="row">
            <div class="col">
              <button type="button" class="btn px-5 btn-primary  "><a class="anchorTag"
                  href="/chat/{{$candidate->userId}}">Chat</a></button>
              <button type="button" class="btn px-5 btn-primary"><a class="anchorTag"
                  href="/ViewProfile/{{$candidate->userId}}">View Profile</a></button>
