...
<body>
    ...
    <div class="container">
        <ul class="nav nav-pills nav-pills-primary">
            <li class="{{ $tabactive == 1 ? 'active' : '' }}"><a data-toggle="pill" href="#appliedjob">Applied Jobs</a>
            </li>
            <li class="{{ $tabactive == 2 ? 'active' : '' }}"><a data-toggle="pill" href="#menu1">Post Jobs</a></li>
            <li class="{{ $tabactive == 3 ? 'active' : '' }}"><a data-toggle="pill" href="#menu2">Offer Recieved</a>
            </li>
        </ul>
            ...
            <div id="appliedjob" class="tab-pane fade in {{ $tabactive == 1 ? 'active' : '' }}">
                ...
                <div class="container">
                    ...
                    <div class="row rounded">
                        ...
                        <div
                            class="col-5 bgcolorp ScrollingJobs justify-content-center text-center outleftcontainerunder">
                            ...
                            <div class="col-5 p-2 w-100 JobListItem text-start bg-white rounded my-3">
                                <a href="/deleteAppliedJob/{{$data->applyId}}" class="btn bg-primary"
                    ...
                    <div class="row rounded">
                        ...
                        <div
                            ...
                            <div class="col-5 p-2 w-100 JobListItem text-start bg-white rounded my-3">
                                ...
                                <a href="/postJobdelete/{{$job->postId}}" class="btn bg-primary"
                                    styel="text-decoration: none;">Delete</a>
                                <a href="/postJobDescription/{{$job->postId}}" class="btn bg-primary"
                                    styel="text-decoration: none;">Description</a>
                ...
                <div class="container">
                    ...
                    <div class="row rounded">
                        ...
                        <div
                            ...
                            <div class="col-5 p-2 w-100 JobListItem text-start bg-white rounded my-3">
                                <a href="/deleteoffer/{{$offers->applyId}}" class="btn bg-primary"
                                    styel="text-decoration: none;">Delete</a>
                                <a href="/offerJobDescription/{{$offers->applyId}}" class="btn bg-primary"
                                    styel="text-decoration: none;">Description</a>
                        ...
                        <div class=" col-7  ScrollingJobs ">
                            ...
                            <div>
                                ...
                                <i class="bi bi-bag-fill h6"> {{$offerRecievedfirst->fName}}
                                    (Internship,fullTime,Remote)</i><br>
